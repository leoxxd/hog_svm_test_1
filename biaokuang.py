...
box_list = []
ANN = os.listdir('E:/dataset/INRIA Person Dataset/person_1/INRIAPerson/Train/annotations/')
flag = "(Xmax, Ymax)"
for i in range(len(ANN)):
    for line in open('E:/dataset/INRIA Person Dataset/person_1/INRIAPerson/Train/annotations/'+ANN[i],encoding="GBK"):
        if flag in line:
...
# print(minscale)
# print(maxscale)
clf = joblib.load("E:/hog_svm_test1/result_hog/trained_svm.m")

imglist = os.listdir('E:/dataset/INRIA Person Dataset/person_1/INRIAPerson/Test/pos')
for i in range(50,len(imglist)):
    img = io.imread(osp.join('E:/dataset/INRIA Person Dataset/person_1/INRIAPerson/Test/pos', imglist[i]))
    ...
    cv2.imwrite('E:/hog_svm_test1/result_hog/result_img/'+imglist[i]+".jpg",img)
    # print(str(i))
    if i == 150:
        break
